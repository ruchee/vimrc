...
syn region rbsTypeArguments matchgroup=rbsDelimiter start=/\%#=1\[/ end=/\%#=1]/ contained contains=@rbsTypes nextgroup=rbsTypeOperator,rbsRHSComment skipwhite skipnl
...
syn region rbsComment matchgroup=rbsCommentStart start=/\%#=1#/ end=/\%#=1$/ oneline contains=rbsTodo
...
syn region rbsMethodParameters matchgroup=rbsDelimiter start=/\%#=1(/ end=/\%#=1)/ contained contains=@rbsTypes,rbsMethodUnaryOperator nextgroup=rbsMethodArrow,rbsMethodBlock,rbsTypeOperator,rbsRHSComment skipwhite skipnl
...
syn match rbsClassName /\%#=1\u\w*/ contained nextgroup=rbsTypeArguments,rbsNamespaceSeparator,rbsDeclarationOperator,rbsTypeOperator,rbsRHSComment,rbsOptionalTypeOperator skipwhite skipnl
syn match rbsInterfaceName /\%#=1_\u\w*/ contained nextgroup=rbsTypeArguments,rbsTypeOperator,rbsRHSComment,rbsOptionalTypeOperator skipwhite skipnl

syn keyword rbsSingleton singleton contained nextgroup=rbsSingletonArgument
syn region rbsSingletonArgument matchgroup=rbsDelimiter start=/\%#=1(/ end=/\%#=1)/ contained contains=rbsClassName,rbsNamespaceSeparator nextgroup=rbsTypeOperator,rbsRHSComment,rbsOptionalTypeOperator skipwhite skipnl

syn match rbsAliasName /\%#=1\l\w*/ contained nextgroup=rbsDeclarationOperator,rbsTypeOperator,rbsRHSComment,rbsOptionalTypeOperator skipwhite skipnl
...
syn match rbsInteger /\%#=10\%([bB][01]\+\%(_[01]\+\)*\|[oO]\o\+\%(_\o\+\)*\|[dD]\d\+\%(_\d\+\)*\|\o*\%(_\o\+\)\+\)\=/ contained nextgroup=rbsTypeOperator,rbsRHSComment,rbsOptionalTypeOperator skipwhite skipnl
...
syn keyword rbsType self instance class bool boolish untyped nil top bot void contained nextgroup=rbsTypeOperator,rbsRHSComment,rbsOptionalTypeOperator skipwhite skipnl
...
syn region rbsRHSComment matchgroup=rbsCommentStart start=/\%#=1#/ end=/\%#=1$/ contained oneline nextgroup=rbsTypeOperator,rbsRHSComment skipwhite skipnl
