...
"   range of lines.
"
"   2014-02-15: This version has been modified from the one included in VIM to
"   use a custom JavaScript indenter for embedded JavaScript.
"
" Credits:
...
" @jason0x43: {{{
" Let the JavaScript indenter set b:did_indent
...
func! s:Alien3() "{{{
	...
	" @jason0x43: call the JavaScript indenter
